...
// Asegurar columna ruc si falta (SQLite/MySQL simple)
try {
    $cols = [];
    ...
    if (!itform_csrf_validate($_POST['csrf_token'] ?? null)) {
        ...
        try {
            ...
            $fields = [
                ...
                'color_primario' => trim((string) ($_POST['color_primario'] ?? '#001F3F')),
                'color_secundario' => trim((string) ($_POST['color_secundario'] ?? '#4CAF50')),
            ...
            logAudit($db, currentUserId(), 'UPDATE', 'configuracion', 1, 'Configuración de empresa actualizada: ' . $fields['nombre_empresa']);
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input name="color_primario" value="<?php echo itform_e($config['color_primario'] ?? '#001F3F'); ?>">
                </div>
                <div class="form-group">
                    <label>Color secundario</label>
                    <input name="color_secundario" value="<?php echo itform_e($config['color_secundario'] ?? '#4CAF50'); ?>">
                </div>
                <div class="form-group">
            ...
            <div class="form-grid">
                <div class="form-group">
                    <label>Logo principal (header / PDF)</label>
                    <div style="margin:8px 0;">
                        <img src="../<?php echo itform_e($logoUrl); ?>?t=<?php echo time(); ?>" alt="Logo actual" style="max-height:80px;max-width:220px;background:#fff;border:1px solid #ddd;padding:6px;border-radius:6px;">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div style="margin:8px 0;">
                        <img src="../<?php echo itform_e($logoFooterUrl); ?>?t=<?php echo time(); ?>" alt="Logo footer" style="max-height:50px;max-width:160px;background:#fff;border:1px solid #ddd;padding:6px;border-radius:6px;">
                    </div>
